  ...
  return (
    <div>
      <div className="bg-[#1D968B] h-full w-screen rounded-b-[63px]  min-h-[621px] max-w-[768px]  relative">
        ...
        <IonIcon src={Dshape} className="min-w-[348px]   min-h-[293px] absolute right-0" />
      ...
      <p className="stext-[16px] font-normal text-[#636466] mt-[23px] px-[21px]  leading-[130%]">
        爪噛み、抜毛、皮膚むしり、唇を噛む等の癖がやめられず、困っている方へ
      </p>
      <div className=" mt-[59px] mb-[23px] mx-[21px]">
